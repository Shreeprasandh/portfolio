  ...
  return (
    <div className="relative w-full h-[90vh] bg-[#1B1B1B] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center px-6">
        ...
        {/* Relative wrapper so that the absolute hamster wheel is positioned relative to the heading */}
        <div className="relative flex flex-col items-center">
          {/* Hamster Wheel Animation (Absolute positioned above the heading) */}
          <div 
